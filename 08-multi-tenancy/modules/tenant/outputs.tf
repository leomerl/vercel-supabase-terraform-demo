...
output "supabase_anon_key" {
  description = "The anonymous API key for the Supabase project (manually retrieve from Supabase dashboard)"
  value       = "Manual retrieval required - check Supabase dashboard for project ${supabase_project.main.id}"
}

output "vercel_project_url" {
  description = "The URL of the Vercel project"
  value       = "https://${var.tenant_name}-${var.project_name}.vercel.app"
}
